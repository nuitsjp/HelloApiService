...
{
    public partial class HelloApiService : ServiceClient<HelloApiService>, IHelloApiService
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the HelloApiService class.
        /// </summary>
        /// <param name='handlers'>
        /// Optional. The delegating handlers to add to the http client pipeline.
        /// </param>
        protected HelloApiService(params DelegatingHandler[] handlers) : base(handlers)
        {
            this.Initialize();
        }
        ...
        /// Optional. The delegating handlers to add to the http client pipeline.
        /// </param>
        protected HelloApiService(HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : base(rootHandler, handlers)
        {
            this.Initialize();
        }
        ...
        /// Optional. The delegating handlers to add to the http client pipeline.
        /// </param>
        protected HelloApiService(Uri baseUri, params DelegatingHandler[] handlers) : this(handlers)
        {
            if (baseUri == null)
            {
        ...
        /// Optional. The delegating handlers to add to the http client pipeline.
        /// </param>
        protected HelloApiService(Uri baseUri, HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : this(rootHandler, handlers)
        {
            if (baseUri == null)
            {
                throw new ArgumentNullException("baseUri");
        ...
        /// Optional. The delegating handlers to add to the http client pipeline.
        /// </param>
        public HelloApiService(ServiceClientCredentials credentials, params DelegatingHandler[] handlers) : this(handlers)
        {
            if (credentials == null)
            {
        ...
        /// Optional. The delegating handlers to add to the http client pipeline.
        /// </param>
        public HelloApiService(ServiceClientCredentials credentials, HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : this(rootHandler, handlers)
        {
            if (credentials == null)
            {
                throw new ArgumentNullException("credentials");
        ...
        /// Optional. The delegating handlers to add to the http client pipeline.
        /// </param>
        public HelloApiService(Uri baseUri, ServiceClientCredentials credentials, params DelegatingHandler[] handlers) : this(handlers)
        {
            if (baseUri == null)
            {
                throw new ArgumentNullException("baseUri");
        ...
        /// Optional. The delegating handlers to add to the http client pipeline.
        /// </param>
        public HelloApiService(Uri baseUri, ServiceClientCredentials credentials, HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : this(rootHandler, handlers)
        {
            if (baseUri == null)
            {
                throw new ArgumentNullException("baseUri");
